...
fun HomeScreen(
    ...
    Column(
        ...
        Row(
            ...
            horizontalArrangement = Arrangement.Start // Align items horizontally from the start
        ) {
            // Image
            Image(
            ...
            Text(
                text = "BUZZLINE",
                style = MaterialTheme.typography.bodyMedium, // Apply your desired text style
